...
const NavigationBarWithProps = () => {
  return <NavigationBar lang={lang} logo={logo} colors={colors} />;
};
...
const NavBar = ({ match }) =>
  console.log("match", match) || <NavigationBarWithProps />;
...
class App extends Component {
  ...
  render() {
    return (
      <BrowserRouter>
        <React.Fragment>
          <Route path="/:id" component={NavigationBar} />
