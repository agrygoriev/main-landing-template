...
const ContactsPagePropsEn = () => {
  return (
    <ContactsPage {...contacts.en} colors={colors} footer={footerInfo.en} />
  );
};
const ContactsPagePropsDe = () => {
  return (
    <ContactsPage {...contacts.de} colors={colors} footer={footerInfo.de} />
  );
};
const ContactsPagePropsEs = () => {
  return (
    <ContactsPage {...contacts.es} colors={colors} footer={footerInfo.de} />
  );
};
