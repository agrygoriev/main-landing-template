...
const ArticlePageWithPropsEn = props => {
  return <ArticlePage content={blogPropsEn} {...props} />;
};
const ArticlePageWithPropsDe = props => {
  return <ArticlePage content={blogPropsDe} {...props} />;
};
const ArticlePageWithPropsEs = props => {
  return <ArticlePage content={blogPropsEs} {...props} />;
};
const TermsPageWithPropsEn = () => {
  return <TermsPage {...termsPropsEn} />;
};
const TermsPageWithPropsDe = () => {
  return <TermsPage {...termsPropsDe} />;
};
const TermsPageWithPropsEs = () => {
  return <TermsPage {...termsPropsEs} />;
};
    ...
    return (
      <BrowserRouter>
        <React.Fragment>
          ...
          <Route exact path="/es/contacts/" component={ContactsPagePropsEs} />
          <Route path="/terms/" component={TermsPageWithPropsEn} />
          <Route path="/de/terms/" component={TermsPageWithPropsDe} />
          <Route path="/es/terms/" component={TermsPageWithPropsEs} />
          {/*<TellMeMore
            ...
            colors={colors}
          /> */}
          <Route exact path="/blog/:id" component={ArticlePageWithPropsEn} />
          <Route exact path="/de/blog/:id" component={ArticlePageWithPropsDe} />
          <Route exact path="/es/blog/:id" component={ArticlePageWithPropsEs} />
        </React.Fragment>
      </BrowserRouter>
    );
  }
