...
const MainSection = props => {
  ...
  const MainPageWithProps = () => {
    return <MainPage {...mainPageProps} colors={props.colors} lang={lang} />;
  };
  const MainPageWithPropsEn = () => {
    return <MainPage {...mainPageProps} colors={props.colors} lang={lang.en} />;
  };
  ...
  return (
    <main>
      ...
      <Route exact path="/en/" component={MainPageWithPropsEn} />
