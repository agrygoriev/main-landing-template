...
const mainPagePropsDe = {
  ...
  corporate: mainPagePropscontacts.de,
  footer: footerInfocontacts.de,
  navbar: navbarPropscontacts.de,
  relative1: relativeContent1contacts.de,
  relative2: relativeContent2contacts.de,
  cards: cardsContentcontacts.de,
  author: authorDatacontacts.de,
  testimonials: testimonialsContentcontacts.de
};
...
mainPagePropsDe.cards = cardsContent.de;
mainPagePropsDe.author = authorData.de;
mainPagePropsDe.testimonials = testimonialsContent.de;
const privacyProps = {
  text: privacyData,
  colors: colors
};
...
const MainPageWithPropsDe = () => {
  return <MainPage {...mainPagePropsDe} colors={colors} />;
};
const MainPageWithPropsEn = () => {
  return <MainPage {...mainPagePropsEn} colors={colors} />;
};
